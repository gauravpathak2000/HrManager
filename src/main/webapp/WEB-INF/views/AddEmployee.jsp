...
<body style="background-color: white;">
	...
	<h3 class="text-info" style=" margin-left: 280px" >EMPLOYEE MANAGEMENT PORTAL</h3>
		 <a href = "logout" class = "navbar-brand" style="float:right;"><i class="fa fa-sign-out" style="font-size:36px;color:red"></i> </a>
	</div>
		...
		<fieldset class="border p-3 " style="margin-top: 30px;">
			...
			<div>
				...
				<div class="container" style="margin-top: 20px">
					<form action="apiAddEmployee" class="formadjust" method="post" class="mt-10">
						<div class=" container center_div">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label">Employee Code </label>
								<div class="col-sm-5">
									<input type="text" class="form-control" required name="empCode"
							...
							<div class="form-group row">
								...
								<div class="col-sm-5">
									<input type="date" class="form-control" name="dob"
										required placeholder="Employee DOB">
								</div>
							</div>
							<br>
							<div>
							...
							<div class="form-group row">
								<div class="col-sm-5">
									<button style="margin:15px;" type="submit" class="btn btn-success">Save</button>
